...
<body>
												...
												<!--/login-top-->
													...
													<h2 class="inner-tittle page"></h2>
														...
														<h3 class="inner-tittle t-inner">Login</h3>
																...
																<form method="POST">
																		Email Address : 
																		<input type="text" name="uemail" class="text" value="E-mail address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}" >
																		Password :
																		<input type="password" name="upass" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
	...
	<?php
		if(isset($_POST['submit']))
		{
			$email=$_POST['uemail'];
			$pass=$_POST['upass'];
		$query=("SELECT * FROM login_table WHERE ROLE=1");
		$run=mysqli_query($con,$query);
		$query1=("SELECT * FROM login_table WHERE STATUS=1");
