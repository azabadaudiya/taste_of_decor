                ...
                <div class="ecom-contenthny-w3lcheckout privacy">
                        ...
                        <table class="timetable_sub">
                            <thead>
								...
								while($value = mysqli_fetch_array($run))
								{
									...
									$totalamount = $totalamount + ($value1['PRODUCT_PRICE']*$value['QUANTITY']);
							?>
                            </thead>
                    ...
                    <div class="row checkout-left mt-5">
                        <div class="col-md-4 checkout-left-basket">
                            <a href="products.php"><h4>Continue to basket</h4></a>
                        ...
                        <div class="col-md-8 address_form_agile ps-lg-5">
							...
							<?php if(isset($_POST['del']))
							{
								...
								{
									echo "<script> alert('Information Not Added');</script>";
								}
							}?>
