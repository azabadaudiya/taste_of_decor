                ...
                <div class="sp-store-single-page row">
                    <div class="col-lg-5 single-right-left">
                        <div class="flexslider1">
                            ...
                            <ul class="slides">
                                <li data-thumb="assets/images/cart1.jpg">
                                    <div class="thumb-image"> <img src="../../retailer/ret_img/<?php echo $value['PRODUCT_IMAGE']; ?>" data-imagezoom="true" class="img-fluid radius-image" alt=" "> </div>
                                </li>
                        ...
                        <div class="eco-buttons mt-5 d-flex">
                            ...
                            <div class="buyhny-now"> <a href="#" class="btn btn-style btn-primary">Buy Now </a></div>
                    ...
                    <div class="col-lg-7 single-right-left ps-lg-5">
                        ...
                        <div class="caption">
                            ...
                            <h6>
                                <span class="item_price"><?php echo $value['PRODUCT_PRICE'];?></span>
                                 Free Delivery
                            </h6>
                        </div>
