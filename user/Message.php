...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/07-12-2021/shoppykart-liberty-demo_Free/1589417704/web/error.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Jan 2022 08:29:00 GMT -->
        ...
        <div class="w3l-error-grid py-5 text-center">
            <div class="container py-lg-4">
                <div class="error-block">
                    ...
                    <a href="payment.php" class="btn btn-style btn-primary mt-4"> <span class="fa fa-arrow-left me-2"></span> Continue to payment</a>
                </div>
            </div>
        </div>
    </section>
