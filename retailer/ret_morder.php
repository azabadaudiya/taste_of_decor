													...
													<div class="graph">
															<div class="tables">
																<table class="table table-hover"> 
																	...
																	<tbody> 
																		<?php
																			$query = "SELECT O.ORDER_ID,O.EMAIL_ID,O.ORDER_STATUS,O.ORDER_DATE,O.ADDRESS,O.PRODUCT_ID,P.PRODUCT_ID,P.PRODUCT_IMAGE,P.PRODUCT_NAME FROM order_table O,products_table P where O.PRODUCT_ID=P.PRODUCT_ID AND O.LOGIN_ID='$lid'";
