		...
		<!-- header-starts -->
											...
											<!--//set-1-->
																		...
																		<div class="set-1">
																			<div class="graph-2 general">
																				<h3 class="inner-tittle two">Add New Retailer  </h3>
																					<div class="grid-1">
																							<div class="form-body">
																									<form method="POST" class="form-horizontal">
																										<div class="form-group">
																											<label for="focusedinput" class="col-sm-2 control-label">Retailer Name</label>
																											<div class="col-sm-8">
																										...
																										<div class="form-group">
																										<div class="form-group">
																										<label class="col-md-2 control-label">Retailer Email</label>
																										<div class="col-md-8">
																										...
																										<div class="col-md-8">
																											<div class="input-group">
																												...
																												<input type="password" class="form-control1 icon" id="exampleInputPassword1" name="a_pass" placeholder="Password" required pattern="[a-zA-Z0-9]{6,12}">
																											</div>
																										</div>
																									</div>
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">
																												...
																												<input type="password" class="form-control1 icon" id="exampleInputPassword1" name="a_repass" placeholder="Re-type Password" required pattern="[a-zA-Z0-9]{6,12}">
																											</div>
																										</div>
																									</div>
			...
			<?php
				if(isset($_POST['add']))
				{
					...
					{
						echo "<script> alert('Retailer Not Added');</script>";
					}
