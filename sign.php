													...
													<h2 class="inner-tittle page"></h2>
														...
														<h3 class="inner-tittle t-inner">Sign Up</h3>
																<form>
																		...
																		Email Address : <input type="text" class="text" value="E-mail address" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}" >
																		Password : <input type="password" value="Password" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
