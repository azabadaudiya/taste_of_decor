																		...
																		<?php
																			...
																			while($value = mysqli_fetch_array($result))
																			{
																				...
																				<tr>
																					...
																					<td> <a href="?del=<?php echo $value['sr_no'];?>" onclick="return confirm('Are you sure you want to delete admin?')">DELETE </a> </td>
																				<td> <a href="con_edit.php?id=<?php echo $value['sr_no'];?>"> CONTACT USER </a> </td>
																				</tr>
																			<?php
																			}
