									...
									<!--sub-heard-part-->
									  <div class="sub-heard-part">
									   <ol class="breadcrumb m-b-0">
											...
											<li class="active"> View Contact Expert</li>
										</ol>
									   </div>
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
													...
													<h3 class="inner-tittle two">View Contact Expert </h3>
													<div class="graph">
															<div class="tables">
																...
																<table border="2" class="table table-hover"> 
																	<thead> <tr height="75px"> 
																		...
																		<?php
																			$query = "select * from contact_exp_table WHERE EXPERT_ID='$id'";
																			...
																			while($value = mysqli_fetch_array($result))
																			{
																				...
																				<tr>
																					...
																					<td> <a href="?del=<?php echo $value['CONTACT_ID'];?>" onclick="return confirm('Are you sure you want to delete review?')">DELETE </a> </td>
																				</tr>
																	<?php
																			}
																				...
																				if(isset($_GET['del']))
																				{
																					$sq = "delete from contact_exp_table where CONTACT_ID=".$_GET['del']."";
																					...
																					header("location:exp_contexp.php");
																					}
																					else
																					{
