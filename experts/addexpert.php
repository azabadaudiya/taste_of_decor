																							...
																							<div class="form-body">
																									<form method="POST" class="form-horizontal" enctype="multipart/form-data">
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												<input type="text" class="form-control1" id="focusedinput" name="e_name" placeholder="Write expert's full name">
																											</div>
																										...
																										<div class="col-md-8">
																											<div class="input-group">							
																												...
																												<input type="text" class="form-control1 icon" name="e_email" placeholder="Email Address">
																											</div>
																										</div>
																										</div>
																										...
																										<div class="col-md-8">
																											<div class="input-group">
																												...
																												<input type="password" class="form-control1 icon" id="exampleInputPassword1" name="e_pass" placeholder="Password">
																											</div>
																										</div>
																									</div>
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">
																												...
																												<input type="password" class="form-control1 icon" id="exampleInputPassword1" name="e_repass" placeholder="Confirm Password">
																											</div>
																										</div>
																									</div>
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">							
																												...
																												<input type="text" class="form-control1 icon" name="e_wexp" placeholder="Expert's work experience">
																											</div>
																										</div>
																										</div>
																										</div>
																										...
																										<div class="form-group">
																											...
																											<div class="col-sm-8">
																												<input type="text" class="form-control1 input-sm" id="smallinput" name="e_phone" placeholder="Enter contact number">
																											</div>
																										</div>
