													...
													<h2 class="inner-tittle page"></h2>
														...
														<h3 class="inner-tittle t-inner">Edit Admin Data</h3>
																...
																<form method="POST" enctype="multipart/form-data">
																		Expert's Email-ID: <input type="text" class="text" value=<?php echo $email;?>  name="e_email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'E-mail address';}" >
																
																		Contact Number :
																		<input type="text" name="e_phone" value=<?php echo $contact;?> onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
